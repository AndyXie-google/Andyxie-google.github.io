...
$$
\alpha_{2j}= \frac{{{e^{\frac{{{Q_2} \cdot {K_1}}}{{\sqrt 5 }}}}}}{{{e^{\frac{{{Q_2} \cdot {K_1}}}{{\sqrt 5 }}}} + {e^{\frac{{{Q_2} \cdot {K_2}}}{{\sqrt 5 }}}} + {e^{\frac{{{Q_2} \cdot {K_3}}}{{\sqrt 5 }}}} + {e^{\frac{{{Q_2} \cdot {K_4}}}{{\sqrt 5 }}}}}}=\frac{e^{\tilde{s}_{2j}}}{\sum_{m=1}^{4}e^{\tilde{s}_{2m}}},\quad j=1,2,3,4
$$
